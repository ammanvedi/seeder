...
seedling.getUser = function(requested_username, next){
	...
	var query = connection.query('SELECT firstname,lastname,username,avatarurl,bio,locationname,bannerurl from users, locations WHERE (username =  \'' + requested_username +'\') AND (locations.locationid = users.locationid);',function(err, results) {
